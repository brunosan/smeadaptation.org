...
function readDefaults(id){
	    ...
	    $.ajax({
	 	...
	 	_gaq.push(['_setCustomVar',
	      ...
	      'Load_region',     // The name acts as a kind of category for the user activity.  Required parameter.
	      id,               // This value of the custom variable.  Required parameter.
...
function applyClass(){
	...
	countResults();
	_gaq.push(['_setCustomVar',1,'change_'+region_id+"-"+id+"-"+id_val, 3 ]);
}
...
function countResults(){
	...
	block=["Equal_treatment_by_local_authorities","Investment_safety","Government_transparency",
	"Ease_of_starting_a_business","Consistent_law_enforcement","Tax_fairness","Political_stability"]
	var Lows = countBlock(block,sector,"low");
